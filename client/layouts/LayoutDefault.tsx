...
function Footer() {
	const d = useData<BaseData | undefined>()
	const instagramUrl = d?.setting?.instagram;
				...
				<div className="flex flex-col md:flex-row md:justify-between gap-6">
					...
					{instagramUrl && (
						<div className="flex items-center">
							<a href={instagramUrl} target="_blank" className="h-6 w-6 text-white hover:text-emerald-200 transition-colors">
