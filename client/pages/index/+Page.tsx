			...
			<div className="max-w-screen-2xl mx-auto py-4 px-4">
				<div className="flex items-center gap-4">
					...
					<Button
						onClick={onClick}
						loading={loading}
						className="w-full py-3 bg-amber-400 hover:bg-amber-300 focus:bg-amber-500 text-base font-bold text-stone-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-amber-500"
					>
						Acheter — {price} €
					</Button>
				</div>
